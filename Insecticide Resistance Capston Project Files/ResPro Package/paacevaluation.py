...
for f in range(0,100):
    #get processed file
    fin1 = open("PAAC/Train/proteinsPAAC" +str(f+1) + ".train", "r")
    ...
    for i in range(len(groups)): 
        dataWrite = open("PAAC/SVMResults/dataWrite3.train", "w")
        testWrite = open("PAAC/SVMResults/testWrite3.data", "w")
        ...
        resultFile = open("PAAC/SVMResults/results3.out", "r")
