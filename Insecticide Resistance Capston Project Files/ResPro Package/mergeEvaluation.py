...
for f in range(0,100):
    #get processed file
    fin1 = open("Combined/Train/proteinsCombined" +str(f+1) + ".train", "r")    
    ...
    for i in range(len(groups)): 
        dataWrite = open("Combined/SVMResults/dataWrite4.train", "w")
        testWrite = open("Combined/SVMResults/testWrite4.data", "w")
        ...
        subprocess.call("./svm-train -c 2 -g 0.5 Combined/SVMResults/dataWrite4.train", stdout=subprocess.PIPE,shell=True)
        print("Training and Testing...  " + str(f),end='\r',flush=True)
        subprocess.call("./svm-predict Combined/SVMResults/testWrite4.data dataWrite4.train.model Combined/SVMResults/results4.out", stdout=subprocess.PIPE,shell=True)
        resultFile = open("Combined/SVMResults/results4.out", "r")
