...
for f in range(0,100):
    #get processed file
    fin1 = open("DPC/Train/proteinsDPC"+str(f+1) + ".train", "r")
    ...
    for i in range(len(groups)): 
        dataWrite = open("DPC/SVMResults/dataWrite2.train", "w")
        testWrite = open("DPC/SVMResults/testWrite2.data", "w")
        ...
        resultFile = open("DPC/SVMResults/results2.out", "r")
